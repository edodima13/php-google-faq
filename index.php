...
$faq = [
    ...
    [
        'd' => '<h2> Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro? </h2>',
        'r' => '<p> Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un\'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno. </p>
    ...
    [
        'd' => '<h2> Perché il mio account è associato a un paese? </h2>',
        'r' => '<p> Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose: </p>
                <ol> 
                    <li> 
